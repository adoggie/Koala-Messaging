...
// -- STRUCT -- 
	...
	this.getsize = function(){
		...
		size+= 8;
		size+= 4;
		var _sb_3 = utf16to8(this.device_id);
	...
	this.marshall = function(view,pos){
		...
		pos+=4;
		var _sb_5 = utf16to8(this.device_id).getBytes();
...
// -- STRUCT -- 
	...
	this.getsize = function(){
		var size =0;
		size+= 4;
		var _sb_1 = utf16to8(this.url);
		size+= 4 + _sb_1.getBytes().length;
		size+= 4;
		var _sb_2 = utf16to8(this.activity);
		size+= 4 + _sb_2.getBytes().length;
		var _sb_3 = utf16to8(this.intent);
		size+= 4 + _sb_3.getBytes().length;
		size+= 4;
		size+= 4;
		var _sb_4 = utf16to8(this.package_name);
		size+= 4 + _sb_4.getBytes().length;
		var _sb_5 = utf16to8(this.package_download_url);
	...
	this.marshall = function(view,pos){
		...
		pos+=4;
		var _sb_1 = utf16to8(this.url).getBytes();
		view.setInt32(pos,_sb_1.length);
		pos+=4;
		var _sb_2 = new Uint8Array(view.buffer);
		_sb_2.set(_sb_1,pos);
		...
		pos+=4;
		var _sb_3 = utf16to8(this.activity).getBytes();
		view.setInt32(pos,_sb_3.length);
		pos+=4;
		var _sb_4 = new Uint8Array(view.buffer);
		_sb_4.set(_sb_3,pos);
		pos += _sb_3.length;
		var _sb_5 = utf16to8(this.intent).getBytes();
		view.setInt32(pos,_sb_5.length);
		pos+=4;
		var _sb_6 = new Uint8Array(view.buffer);
		_sb_6.set(_sb_5,pos);
		...
		pos+=4;
		var _sb_7 = utf16to8(this.package_name).getBytes();
		view.setInt32(pos,_sb_7.length);
		pos+=4;
		var _sb_8 = new Uint8Array(view.buffer);
		_sb_8.set(_sb_7,pos);
		pos += _sb_7.length;
		var _sb_9 = utf16to8(this.package_download_url).getBytes();
	...
	this.unmarshall = function(view,pos){
		...
		this.activity = utf8to16(this.activity);
		var _sb_5 = view.getUint32(pos);
		pos+=4;
		...
		this.intent = utf8to16(this.intent);
		...
		this.package_name = utf8to16(this.package_name);
		...
		this.package_download_url = utf8to16(this.package_download_url);
...
// -- STRUCT -- 
	...
	this.getsize = function(){
		var size =0;
		var _sb_1 = utf16to8(this.seq);
		size+= 4 + _sb_1.getBytes().length;
		var _sb_2 = utf16to8(this.sender_id);
		size+= 4 + _sb_2.getBytes().length;
		var _sb_3 = utf16to8(this.send_time);
		size+= 4 + _sb_3.getBytes().length;
		var _sb_4 = utf16to8(this.title);
		size+= 4 + _sb_4.getBytes().length;
		var _sb_5 = utf16to8(this.content);
		size+= 4 + _sb_5.getBytes().length;
		return size;
	}	;	
	...
	// 
	this.marshall = function(view,pos){
		var _sb_1 = utf16to8(this.seq).getBytes();
		view.setInt32(pos,_sb_1.length);
		pos+=4;
		var _sb_2 = new Uint8Array(view.buffer);
		_sb_2.set(_sb_1,pos);
		pos += _sb_1.length;
		var _sb_3 = utf16to8(this.sender_id).getBytes();
		view.setInt32(pos,_sb_3.length);
		pos+=4;
		var _sb_4 = new Uint8Array(view.buffer);
		_sb_4.set(_sb_3,pos);
		pos += _sb_3.length;
		var _sb_5 = utf16to8(this.send_time).getBytes();
		view.setInt32(pos,_sb_5.length);
		pos+=4;
		var _sb_6 = new Uint8Array(view.buffer);
		_sb_6.set(_sb_5,pos);
		pos += _sb_5.length;
		var _sb_7 = utf16to8(this.title).getBytes();
		view.setInt32(pos,_sb_7.length);
		pos+=4;
		var _sb_8 = new Uint8Array(view.buffer);
		_sb_8.set(_sb_7,pos);
		pos += _sb_7.length;
		var _sb_9 = utf16to8(this.content).getBytes();
		view.setInt32(pos,_sb_9.length);
		pos+=4;
		var _sb_10 = new Uint8Array(view.buffer);
		_sb_10.set(_sb_9,pos);
	...
	this.unmarshall = function(view,pos){
		...
		this.sender_id = utf8to16(this.sender_id);
		var _sb_5 = view.getUint32(pos);
		pos+=4;
		...
		this.send_time = utf8to16(this.send_time);
		var _sb_7 = view.getUint32(pos);
		pos+=4;
		...
		this.title = utf8to16(this.title);
		var _sb_9 = view.getUint32(pos);
		pos+=4;
		...
		this.content = utf8to16(this.content);
		return pos;
	}	;	
	 // --  end function -- 
...
// -- STRUCT -- 
	...
	this.getsize = function(){
		...
		var _sb_2 = utf16to8(this.sender_id);
		size+= 4 + _sb_2.getBytes().length;
		var _sb_3 = utf16to8(this.sent_time);
		size+= 4 + _sb_3.getBytes().length;
		var _sb_4 = utf16to8(this.title);
		size+= 4 + _sb_4.getBytes().length;
		var _sb_5 = utf16to8(this.content);
		size+= 4 + _sb_5.getBytes().length;
		var _sb_6 = utf16to8(this.expire_time);
		size+= 4 + _sb_6.getBytes().length;
		var _sb_7 = utf16to8(this.send_time);
		size+= 4 + _sb_7.getBytes().length;
		var _sb_8 = utf16to8(this.accept_time);
		size+= 4 + _sb_8.getBytes().length;
		size+= 4;
		size+=this.style.getsize();
		size+=this.action.getsize();
		var _sb_9 = utf16to8(this.custom);
		size+= 4 + _sb_9.getBytes().length;
		size+= 4;
		size+= 4;
		var _sb_10 = utf16to8(this.alert);
		size+= 4 + _sb_10.getBytes().length;
		size+= 4;
		var _sb_11 = utf16to8(this.sound);
		size+= 4 + _sb_11.getBytes().length;
		var _sb_12 = utf16to8(this.category);
		size+= 4 + _sb_12.getBytes().length;
		var _sb_13 = utf16to8(this.raw);
	...
	this.marshall = function(view,pos){
		...
		_sb_4.set(_sb_3,pos);
		pos += _sb_3.length;
		var _sb_5 = utf16to8(this.sent_time).getBytes();
		view.setInt32(pos,_sb_5.length);
		pos+=4;
		var _sb_6 = new Uint8Array(view.buffer);
		_sb_6.set(_sb_5,pos);
		...
		var _sb_17 = utf16to8(this.custom).getBytes();
		...
		pos+=4;
		var _sb_19 = utf16to8(this.alert).getBytes();
	...
	this.unmarshall = function(view,pos){
		...
		this.sent_time = utf8to16(this.sent_time);
		var _sb_7 = view.getUint32(pos);
		pos+=4;
		this.title = view.buffer.slice(pos,pos+_sb_7);
		// this var is Uint8Array,should convert to String!!
		...
		this.expire_time = utf8to16(this.expire_time);
		...
		this.accept_time = utf8to16(this.accept_time);
		...
		this.custom = utf8to16(this.custom);
		...
		this.alert = utf8to16(this.alert);
		...
		this.sound = utf8to16(this.sound);
		...
		this.category = utf8to16(this.category);
...
// -- STRUCT -- 
	...
	this.getsize = function(){
		var size =0;
		var _sb_1 = utf16to8(this.type);
		size+= 4 + _sb_1.getBytes().length;
		var _sb_2 = utf16to8(this.title);
		size+= 4 + _sb_2.getBytes().length;
		var _sb_3 = utf16to8(this.content);
		size+= 4 + _sb_3.getBytes().length;
	...
	// 
	this.marshall = function(view,pos){
		var _sb_1 = utf16to8(this.type).getBytes();
		view.setInt32(pos,_sb_1.length);
		pos+=4;
		var _sb_2 = new Uint8Array(view.buffer);
		_sb_2.set(_sb_1,pos);
		pos += _sb_1.length;
		var _sb_3 = utf16to8(this.title).getBytes();
		view.setInt32(pos,_sb_3.length);
		pos+=4;
		var _sb_4 = new Uint8Array(view.buffer);
		_sb_4.set(_sb_3,pos);
		pos += _sb_3.length;
		var _sb_5 = utf16to8(this.content).getBytes();
		view.setInt32(pos,_sb_5.length);
		pos+=4;
		var _sb_6 = new Uint8Array(view.buffer);
		_sb_6.set(_sb_5,pos);
...
function IUserEventListenerProxy(){
	...
	this.onUserOnline_async = function(userid,gws_id,device,async,error,props,cookie){
		...
		try{
			...
			_sb_5.set(_sb_4,_pos);
			_pos += _sb_4.length;
			var _sb_6 = utf16to8(gws_id).getBytes();
			_view.setInt32(_pos,_sb_6.length);
			_pos+=4;
			var _sb_7 = new Uint8Array(_view.buffer);
			_sb_7.set(_sb_6,_pos);
	...
	this.onUserOffline_oneway = function (userid,gws_id,device,error,props){
		...
		try{
			...
			_pos += _sb_11.length;
			var _sb_13 = utf16to8(gws_id).getBytes();
			_view.setInt32(_pos,_sb_13.length);
			_pos+=4;
			var _sb_14 = new Uint8Array(_view.buffer);
			_sb_14.set(_sb_13,_pos);
